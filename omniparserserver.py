...
def parse_arguments():
    ...
    parser.add_argument('--som_model_path', type=str, default=os.path.join(os.getcwd(), 'weights/icon_detect/model.pt'), help='Path to the som model')
    parser.add_argument('--caption_model_name', type=str, default='florence2', help='Name of the caption model')
    parser.add_argument('--caption_model_path', type=str, default=os.path.join(os.getcwd(), 'weights/icon_caption_florence'), help='Path to the caption model')
